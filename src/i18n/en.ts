...
export const messages: Record<string, string> = {
  ...
  'cmd.reply_mode.status': 'Current group reply mode: {mode}\nCommands: /reply-mode chat | topic | new-topic (shared remains a compatibility alias for topic)',
  ...
  'cmd.reply_mode.usage': 'Usage: /reply-mode chat | topic | new-topic\nchat = flat replies while reusing the group session; topic = topic display while reusing the same group session (shared is a compatibility alias); new-topic = each @ opens a fresh topic + its own session.',
